...
class RegistrationTest(TestCase):
    ...
    def testRegistrationProcess(self):
        ...
        self.assertEquals(True, bool(Person.objects.filter(email = 'test@test123default.org')))
        ...
        self.assertNotIn(u'тестовая фамилия', smart_text(response_table.content))
        self.assertNotIn(u'тестовое имя', smart_text(response_table.content))
        self.assertNotIn(u'тестовое отчество', smart_text(response_table.content))
        self.assertNotIn(u'тестовая организация', smart_text(response_table.content))
